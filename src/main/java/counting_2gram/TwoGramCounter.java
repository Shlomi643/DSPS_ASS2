...
public class TwoGramCounter {
    public static class Map extends Mapper<LongWritable, Text, Text, LongWritable> {
        /**
         * Input: 2-gram dataset
         *
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "TwoGramCounter");
        job.setJarByClass(TwoGramCounter.class);
        // input format class :
        ...
        job.setMapperClass(TwoGramCounter.Map.class);
        job.setReducerClass(TwoGramCounter.Reduce.class);
